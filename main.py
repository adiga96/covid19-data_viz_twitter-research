...
def USstate_filteration(f1,K1,K2):
    ...
    # state_df2 = f2[f2['location'].str.contains(K1, na=False) |  f2['location'].str.contains(K2,case=False, na=False)] 
    # state_df3 = f3[f3['location'].str.contains(K1, na=False) |  f3['location'].str.contains(K2,case=False, na=False)] 
    
    # state_merged = pd.concat([state_df1,state_df2,state_df3])
...
# Function to calculate sum and count of Retweets @RT
