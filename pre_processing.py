...
try:
    ...
    for folder in glob.glob('/Volumes/My Passport/Summer 2020_Research/COVID_Tweets/sample/*'):
        ...
        for f in glob.glob(f'{folder}/*.jsonl.gz'):
            ...
            for chunk in read_json:
                ...
                All_PPE = Tweets_US_location [Tweets_US_location ['full_text'].str.contains(r'\b(ppe|mask|shortage|N95|medical supplies|\
                                                surgical|ventilator|respirator|ICU|glove|#ppe|wipes|sanitizer|\
                                                disinfectant| protective equipment)\b', case=False, na=False) ]  
                ...
                with open('/Users/pritishsadiga/Desktop/Twitter/2020-03/march_all_PPE.json', 'ab') as f:
                    f.write(out)
                    print('File Saved')
                    
except EOFError as errors:
    #do nothing
    print('errors')
